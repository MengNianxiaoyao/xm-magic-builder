...
import { consumeWarning } from '../../../webview/actions';
import { INTEGER_VAR_VALUES, STRING_VAR_VALUES, NO_CUSTOM_VAR_TYPES } from './variable-values';
...
export const variablePanel: PanelDescriptor = {
    ...
    fields: [],
    actions: [],
    scripts: ['resources/js/panels/variable.js'],
    dataInject() {
