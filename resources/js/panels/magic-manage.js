(function () {
    ...
    function setFormValues(data) {
        ...
        setSponsorValues(data.sponsorDays || '1');
    }

    function setSponsorValues(sponsorDays) {
        const presets = ['1', '30', '90', '365', '0'];
        const value = presets.indexOf(sponsorDays) !== -1 ? sponsorDays : '1';
        document.querySelectorAll('input[name="sponsor-type"]').forEach(function (radio) {
    ...
    document.getElementById('add-btn').addEventListener('click', function () {
        ...
        const sponsorDays = document.querySelector('input[name="sponsor-type"]:checked').value;
